...
| `azure-di`          | 0,00868 EUR/Seite | Scans auf A4-Normalformat ohne feine Schriften; DI-Standard-OCR reicht.   |
| `azure-di-hr`       | 0,01389 EUR/Seite | Vektor-Zeichnungen (KKS-Labels, Zeichnungskopf), Plan-Format (A3+), Grossbild-Seiten — 4x DPI noetig. |
